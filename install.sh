...
# the Actual beginning or End of the line. Alt + F / Alt + B: Move the cursor Forward or Backward by one full word. 
...
# Ctrl + Y: Paste ("yank") back the last text you deleted with Ctrl+W 
# Ctrl+U, or Ctrl+K. Ctrl + _: Undo the last change to the command line.
# Process & Management Ctrl + L: Clear the terminal screen while keeping your current command line intact. 
